...
HXLINE(  57)		this->debugKeys = ::ClientPrefs_obj::copyKey(( (::Array< int >)(::ClientPrefs_obj::keyBinds->get(HX_("debug_1",05,20,57,5b))) ));
...
HXLINE(  79)		this->add(bg2);
HXLINE(  81)		this->camFollow =  ::flixel::FlxObject_obj::__alloc( HX_CTX ,0,0,1,1);
HXLINE(  82)		this->camFollowPos =  ::flixel::FlxObject_obj::__alloc( HX_CTX ,0,0,1,1);
HXLINE(  83)		this->add(this->camFollow);
HXLINE(  84)		this->add(this->camFollowPos);
HXLINE(  86)		 ::flixel::FlxSprite _hx_tmp2 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-80,null(),null());
HXDLIN(  86)		::String library1 = null();
HXDLIN(  86)		 ::flixel::graphics::FlxGraphic imageToReturn1 = ::Paths_obj::addCustomGraphic(HX_("menuDesat",26,91,04,72));
HXDLIN(  86)		 ::Dynamic _hx_tmp3;
HXDLIN(  86)		if (::hx::IsNotNull( imageToReturn1 )) {
HXLINE(  86)			_hx_tmp3 = imageToReturn1;
            		}
            		else {
HXLINE(  86)			_hx_tmp3 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuDesat",26,91,04,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
            		}
HXDLIN(  86)		this->magenta = _hx_tmp2->loadGraphic(_hx_tmp3,null(),null(),null(),null(),null());
HXLINE(  87)		this->magenta->scrollFactor->set(0,yScroll);
HXLINE(  88)		 ::flixel::FlxSprite _hx_tmp4 = this->magenta;
HXDLIN(  88)		_hx_tmp4->setGraphicSize(::Std_obj::_hx_int((this->magenta->get_width() * ((Float)1.175))),null());
HXLINE(  89)		this->magenta->updateHitbox();
HXLINE(  90)		this->magenta->screenCenter(null());
HXLINE(  91)		this->magenta->set_visible(false);
HXLINE(  92)		this->magenta->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(  93)		this->magenta->set_color(-167525);
HXLINE(  94)		this->add(this->magenta);
HXLINE(  97)		this->menuItems =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE(  98)		this->add(this->menuItems);
HXLINE( 100)		Float scale = ( (Float)(1) );
HXLINE( 105)		{
HXLINE( 105)			int _g = 0;
HXDLIN( 105)			int _g1 = this->optionShit->length;
HXDLIN( 105)			while((_g < _g1)){
HXLINE( 105)				_g = (_g + 1);
HXDLIN( 105)				int i = (_g - 1);
HXLINE( 107)				Float offset = (( (Float)(108) ) - ((::Math_obj::max(( (Float)(this->optionShit->length) ),( (Float)(4) )) - ( (Float)(4) )) * ( (Float)(80) )));
HXLINE( 108)				 ::flixel::FlxSprite menuItem =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,100,(110 + (i * 125)),null());
HXLINE( 109)				menuItem->scale->set_x(scale);
HXLINE( 110)				menuItem->scale->set_y(scale);
HXLINE( 111)				::String key = (HX_("mainmenu/menu_",a9,7b,4b,27) + this->optionShit->__get(i));
HXDLIN( 111)				::String library = null();
HXDLIN( 111)				 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 111)				bool xmlExists = false;
HXDLIN( 111)				if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 111)					xmlExists = true;
            				}
HXDLIN( 111)				 ::Dynamic _hx_tmp;
HXDLIN( 111)				if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 111)					_hx_tmp = imageLoaded;
            				}
            				else {
HXLINE( 111)					 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 111)					if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 111)						_hx_tmp = imageToReturn;
            					}
            					else {
HXLINE( 111)						_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            					}
            				}
HXDLIN( 111)				::String _hx_tmp1;
HXDLIN( 111)				if (xmlExists) {
HXLINE( 111)					_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))));
            				}
            				else {
HXLINE( 111)					_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            				}
HXDLIN( 111)				menuItem->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
HXLINE( 112)				menuItem->animation->addByPrefix(HX_("idle",14,a7,b3,45),(this->optionShit->__get(i) + HX_(" basic",8e,b6,25,79)),24,null(),null(),null());
HXLINE( 113)				menuItem->animation->addByPrefix(HX_("selected",5b,2a,6d,b1),(this->optionShit->__get(i) + HX_(" white",89,d6,28,95)),24,null(),null(),null());
HXLINE( 114)				menuItem->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 115)				menuItem->setGraphicSize(::Std_obj::_hx_int((menuItem->get_width() * ((Float)0.8))),null());
HXLINE( 116)				menuItem->ID = i;
HXLINE( 117)				menuItem->set_x(( (Float)(125) ));
HXLINE( 118)				menuItem->set_angle(( (Float)(7) ));
...
HXLINE( 146)			_hx_tmp5 = (leDate->getHours() >= 18);
            		}
            		else {
...
HXLINE( 247)									::MusicBeatState_obj::switchState( ::options::OptionsState_obj::__alloc( HX_CTX ,null(),null()));
