...
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_152_update,"CreditsState","update",0x5b614be0,"CreditsState.update","CreditsState.hx",152,0xdb40a967)
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_185_changeSelection,"CreditsState","changeSelection",0x5dc3e005,"CreditsState.changeSelection","CreditsState.hx",185,0xdb40a967)
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_203_changeSelection,"CreditsState","changeSelection",0x5dc3e005,"CreditsState.changeSelection","CreditsState.hx",203,0xdb40a967)
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_225_getCurrentBGColor,"CreditsState","getCurrentBGColor",0xd6c58504,"CreditsState.getCurrentBGColor","CreditsState.hx",225,0xdb40a967)
HX_LOCAL_STACK_FRAME(_hx_pos_1bf4423a091ce525_234_unselectableCheck,"CreditsState","unselectableCheck",0x4473c3a2,"CreditsState.unselectableCheck","CreditsState.hx",234,0xdb40a967)
...
HXLINE(  81)		::Array< ::Dynamic> pisspoop = ::Array_obj< ::Dynamic>::__new(17)->init(0,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_9,1))->init(1,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_10,5))->init(2,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_11,5))->init(3,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_12,5))->init(4,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_13,1))->init(5,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_14,1))->init(6,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_15,5))->init(7,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_16,5))->init(8,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_17,5))->init(9,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_18,5))->init(10,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_19,5))->init(11,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_20,1))->init(12,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_21,1))->init(13,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_22,5))->init(14,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_23,5))->init(15,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_24,5))->init(16,::Array_obj< ::String >::fromData( _hx_array_data_3b81c5b7_25,5));
HXLINE( 101)		{
HXLINE( 101)			int _g2 = 0;
HXDLIN( 101)			while((_g2 < pisspoop->length)){
HXLINE( 101)				::Array< ::String > i = pisspoop->__get(_g2).StaticCast< ::Array< ::String > >();
HXDLIN( 101)				_g2 = (_g2 + 1);
HXLINE( 102)				this->creditsStuff->push(i);
            			}
            		}
HXLINE( 105)		{
HXLINE( 105)			int _g3 = 0;
HXDLIN( 105)			int _g4 = this->creditsStuff->length;
HXDLIN( 105)			while((_g3 < _g4)){
HXLINE( 105)				_g3 = (_g3 + 1);
HXDLIN( 105)				int i = (_g3 - 1);
HXLINE( 107)				bool isSelectable = !(this->unselectableCheck(i));
HXLINE( 108)				 ::Alphabet optionText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)((70 * i)) ),this->creditsStuff->__get(i).StaticCast< ::Array< ::String > >()->__get(0),!(isSelectable),false,null(),null());
HXLINE( 109)				optionText->isMenuItem = true;
HXLINE( 110)				optionText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 111)				 ::Alphabet optionText1 = optionText;
HXDLIN( 111)				optionText1->yAdd = (optionText1->yAdd - ( (Float)(70) ));
HXLINE( 112)				if (isSelectable) {
HXLINE( 113)					optionText->set_x((optionText->x - ( (Float)(70) )));
            				}
HXLINE( 115)				optionText->forceX = optionText->x;
HXLINE( 117)				optionText->targetY = ( (Float)(i) );
HXLINE( 118)				this->grpOptions->add(optionText).StaticCast<  ::Alphabet >();
HXLINE( 120)				if (isSelectable) {
HXLINE( 121)					if (::hx::IsNotNull( this->creditsStuff->__get(i).StaticCast< ::Array< ::String > >()->__get(5) )) {
HXLINE( 123)						::Paths_obj::currentModDirectory = this->creditsStuff->__get(i).StaticCast< ::Array< ::String > >()->__get(5);
            					}
HXLINE( 126)					 ::AttachedSprite icon =  ::AttachedSprite_obj::__alloc( HX_CTX ,(HX_("credits/",d5,48,ee,de) + this->creditsStuff->__get(i).StaticCast< ::Array< ::String > >()->__get(1)),null(),null(),null());
HXLINE( 127)					icon->xAdd = (optionText->get_width() + 10);
HXLINE( 128)					icon->sprTracker = optionText;
HXLINE( 131)					this->iconArray->push(icon);
HXLINE( 132)					this->add(icon);
HXLINE( 133)					::Paths_obj::currentModDirectory = HX_("",00,00,00,00);
HXLINE( 135)					if ((this->curSelected == -1)) {
HXLINE( 135)						this->curSelected = i;
            					}
            				}
            			}
            		}
HXLINE( 139)		this->descText =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,50,600,1180,HX_("",00,00,00,00),32,null());
HXLINE( 140)		 ::flixel::text::FlxText _hx_tmp2 = this->descText;
HXDLIN( 140)		::String file = ::Paths_obj::modFolders((HX_("fonts/",eb,13,ef,fa) + HX_("vcr.ttf",9d,d2,a7,82)));
HXDLIN( 140)		::String _hx_tmp3;
HXDLIN( 140)		if (::sys::FileSystem_obj::exists(file)) {
HXLINE( 140)			_hx_tmp3 = file;
            		}
            		else {
HXLINE( 140)			_hx_tmp3 = (HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82));
            		}
HXDLIN( 140)		_hx_tmp2->setFormat(_hx_tmp3,32,-1,HX_("center",d5,25,db,05),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE( 141)		this->descText->scrollFactor->set(null(),null());
HXLINE( 142)		this->descText->set_borderSize(((Float)2.4));
HXLINE( 143)		this->add(this->descText);
HXLINE( 145)		 ::flixel::FlxSprite _hx_tmp4 = this->bg;
HXDLIN( 145)		_hx_tmp4->set_color(( (int)(this->getCurrentBGColor()) ));
HXLINE( 146)		this->intendedColor = this->bg->color;
HXLINE( 147)		this->changeSelection(null());
HXLINE( 148)		this->super::create();
            	}


void CreditsState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_1bf4423a091ce525_152_update)
HXLINE( 153)		if ((::flixel::FlxG_obj::sound->music->_volume < ((Float)0.7))) {
HXLINE( 155)			 ::flixel::_hx_system::FlxSound fh = ::flixel::FlxG_obj::sound->music;
HXDLIN( 155)			fh->set_volume((fh->_volume + (((Float)0.5) * ::flixel::FlxG_obj::elapsed)));
            		}
HXLINE( 158)		bool upP = ::PlayerSettings_obj::player1->controls->_ui_upP->check();
HXLINE( 159)		bool downP = ::PlayerSettings_obj::player1->controls->_ui_downP->check();
HXLINE( 161)		if (upP) {
HXLINE( 163)			this->changeSelection(-1);
            		}
HXLINE( 165)		if (downP) {
HXLINE( 167)			this->changeSelection(1);
            		}
HXLINE( 170)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 172)			if (::hx::IsNotNull( this->colorTween )) {
HXLINE( 173)				this->colorTween->cancel();
            			}
HXLINE( 175)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 175)			_hx_tmp->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
HXLINE( 176)			::MusicBeatState_obj::switchState( ::MainMenuState_obj::__alloc( HX_CTX ,null(),null()));
            		}
HXLINE( 178)		if (::PlayerSettings_obj::player1->controls->_accept->check()) {
HXLINE( 179)			::CoolUtil_obj::browserLoad(this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(3));
            		}
...
void CreditsState_obj::changeSelection(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_185_changeSelection)
HXDLIN( 185)		 ::CreditsState _gthis = ::hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 188)			 ::CreditsState _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 188)			_hx_tmp->curSelected = (_hx_tmp->curSelected + change);
HXLINE( 189)			if ((this->curSelected < 0)) {
HXLINE( 190)				this->curSelected = (this->creditsStuff->length - 1);
            			}
HXLINE( 191)			if ((this->curSelected >= this->creditsStuff->length)) {
HXLINE( 192)				this->curSelected = 0;
            			}
HXLINE( 187)			if (!(this->unselectableCheck(this->curSelected))) {
HXLINE( 187)				goto _hx_goto_27;
            			}
            		}
            		_hx_goto_27:;
HXLINE( 195)		int newColor = ( (int)(this->getCurrentBGColor()) );
HXLINE( 196)		if ((newColor != this->intendedColor)) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::CreditsState,_gthis) HXARGC(1)
            			void _hx_run( ::flixel::tweens::FlxTween twn){
            				HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_203_changeSelection)
HXLINE( 203)				_gthis->colorTween = null();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 197)			if (::hx::IsNotNull( this->colorTween )) {
HXLINE( 198)				this->colorTween->cancel();
            			}
HXLINE( 200)			this->intendedColor = newColor;
HXLINE( 201)			this->colorTween = ::flixel::tweens::FlxTween_obj::color(this->bg,1,this->bg->color,this->intendedColor, ::Dynamic(::hx::Anon_obj::Create(1)
            				->setFixed(0,HX_("onComplete",f8,d4,7e,5d), ::Dynamic(new _hx_Closure_0(_gthis)))));
            		}
HXLINE( 208)		int bullShit = 0;
HXLINE( 210)		{
HXLINE( 210)			int _g = 0;
HXDLIN( 210)			::Array< ::Dynamic> _g1 = this->grpOptions->members;
...
HXLINE( 215)				if (!(this->unselectableCheck((bullShit - 1)))) {
...
HXLINE( 222)		this->descText->set_text(this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(2));
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(CreditsState_obj,changeSelection,(void))
 ...
 ::Dynamic CreditsState_obj::getCurrentBGColor(){
            	HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_225_getCurrentBGColor)
HXLINE( 226)		::String bgColor = this->creditsStuff->__get(this->curSelected).StaticCast< ::Array< ::String > >()->__get(4);
HXLINE( 227)		if (!(::StringTools_obj::startsWith(bgColor,HX_("0x",48,2a,00,00)))) {
HXLINE( 228)			bgColor = (HX_("0xFF",88,89,15,20) + bgColor);
            		}
HXLINE( 230)		return ::Std_obj::parseInt(bgColor);
            	}
...
bool CreditsState_obj::unselectableCheck(int num){
            	HX_STACKFRAME(&_hx_pos_1bf4423a091ce525_234_unselectableCheck)
HXDLIN( 234)		return (this->creditsStuff->__get(num).StaticCast< ::Array< ::String > >()->length <= 1);
            	}
