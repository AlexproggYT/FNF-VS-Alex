...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_216_update,"Character","update",0x0e18944e,"Character.update","Character.hx",216,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_266_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",266,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_284_playAnim,"Character","playAnim",0xed2bd3aa,"Character.playAnim","Character.hx",284,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_315_recalculateDanceIdle,"Character","recalculateDanceIdle",0x9672c319,"Character.recalculateDanceIdle","Character.hx",315,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_320_addOffset,"Character","addOffset",0x6dc9376f,"Character.addOffset","Character.hx",320,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_325_quickAnimAdd,"Character","quickAnimAdd",0x85c31d28,"Character.quickAnimAdd","Character.hx",325,0xf073a2d5)
...
HXLINE( 121)				::String modTxtToFind = ::Paths_obj::modFolders(( (::String)(((HX_("images/",77,50,74,c1) + json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) + HX_(".txt",02,3f,c0,1e))) ));
HXLINE( 122)				::String txtToFind = ::Paths_obj::getPath(( (::String)(((HX_("images/",77,50,74,c1) + json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) + HX_(".txt",02,3f,c0,1e))) ),HX_("TEXT",ad,94,ba,37),null());
HXLINE( 123)				bool _hx_tmp;
HXDLIN( 123)				bool _hx_tmp1;
HXDLIN( 123)				if (!(::sys::FileSystem_obj::exists(modTxtToFind))) {
HXLINE( 123)					_hx_tmp1 = ::sys::FileSystem_obj::exists(txtToFind);
            				}
            				else {
HXLINE( 123)					_hx_tmp1 = true;
            				}
HXDLIN( 123)				if (!(_hx_tmp1)) {
HXLINE( 123)					_hx_tmp = ::openfl::utils::Assets_obj::exists(txtToFind,null());
            				}
            				else {
HXLINE( 123)					_hx_tmp = true;
            				}
HXDLIN( 123)				if (_hx_tmp) {
HXLINE( 129)					::String key = ( (::String)(json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) );
HXDLIN( 129)					::String library = null();
HXDLIN( 129)					 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 129)					bool txtExists = false;
HXDLIN( 129)					if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e))))) {
HXLINE( 129)						txtExists = true;
            					}
...
HXLINE( 129)						 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 129)						if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 129)							_hx_tmp = imageToReturn;
            						}
            						else {
HXLINE( 129)							_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            						}
            					}
HXDLIN( 129)					::String _hx_tmp1;
HXDLIN( 129)					if (txtExists) {
HXLINE( 129)						_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e))));
            					}
            					else {
HXLINE( 129)						_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library);
            					}
HXDLIN( 129)					this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(_hx_tmp,_hx_tmp1));
            				}
            				else {
HXLINE( 133)					::String key = ( (::String)(json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) );
HXDLIN( 133)					::String library = null();
HXDLIN( 133)					 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 133)					bool xmlExists = false;
HXDLIN( 133)					if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 133)						xmlExists = true;
            					}
HXDLIN( 133)					 ::Dynamic _hx_tmp;
HXDLIN( 133)					if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 133)						_hx_tmp = imageLoaded;
            					}
            					else {
HXLINE( 133)						 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(key);
HXDLIN( 133)						if (::hx::IsNotNull( imageToReturn )) {
HXLINE( 133)							_hx_tmp = imageToReturn;
            						}
            						else {
HXLINE( 133)							_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            						}
            					}
HXDLIN( 133)					::String _hx_tmp1;
HXDLIN( 133)					if (xmlExists) {
HXLINE( 133)						_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e))));
            					}
            					else {
HXLINE( 133)						_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            					}
HXDLIN( 133)					this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
            				}
HXLINE( 135)				this->imageFile = ( (::String)(json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) );
HXLINE( 137)				if (::hx::IsNotEq( json->__Field(HX_("scale",8a,ce,ce,78),::hx::paccDynamic),1 )) {
HXLINE( 138)					this->jsonScale = ( (Float)(json->__Field(HX_("scale",8a,ce,ce,78),::hx::paccDynamic)) );
HXLINE( 139)					Float _hx_tmp = this->get_width();
HXDLIN( 139)					this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp * this->jsonScale)),null());
HXLINE( 140)					this->updateHitbox();
            				}
HXLINE( 143)				this->positionArray = ( (::Array< Float >)(json->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic)) );
HXLINE( 144)				this->cameraPosition = ( (::Array< Float >)(json->__Field(HX_("camera_position",c3,d4,4a,56),::hx::paccDynamic)) );
HXLINE( 146)				this->healthIcon = ( (::String)(json->__Field(HX_("healthicon",15,8e,6f,17),::hx::paccDynamic)) );
HXLINE( 147)				this->singDuration = ( (Float)(json->__Field(HX_("sing_duration",84,ae,a8,66),::hx::paccDynamic)) );
HXLINE( 148)				this->set_flipX(( (bool)(json->__Field(HX_("flip_x",26,2b,6a,3d),::hx::paccDynamic)) ));
HXLINE( 149)				if (( (bool)(json->__Field(HX_("no_antialiasing",f2,74,67,98),::hx::paccDynamic)) )) {
HXLINE( 150)					this->set_antialiasing(false);
HXLINE( 151)					this->noAntialiasing = true;
            				}
HXLINE( 154)				bool _hx_tmp2;
HXDLIN( 154)				if (::hx::IsNotNull( json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic) )) {
HXLINE( 154)					_hx_tmp2 = (( (::Array< int >)(json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic)) )->length > 2);
            				}
            				else {
HXLINE( 154)					_hx_tmp2 = false;
            				}
HXDLIN( 154)				if (_hx_tmp2) {
HXLINE( 155)					this->healthColorArray = ( (::Array< int >)(json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic)) );
            				}
HXLINE( 157)				this->set_antialiasing(!(this->noAntialiasing));
HXLINE( 158)				if (!(::ClientPrefs_obj::globalAntialiasing)) {
HXLINE( 158)					this->set_antialiasing(false);
            				}
HXLINE( 160)				this->animationsArray = ( (::Array< ::Dynamic>)(json->__Field(HX_("animations",ef,34,1c,83),::hx::paccDynamic)) );
HXLINE( 161)				bool _hx_tmp3;
HXDLIN( 161)				if (::hx::IsNotNull( this->animationsArray )) {
HXLINE( 161)					_hx_tmp3 = (this->animationsArray->length > 0);
            				}
            				else {
...
HXLINE( 162)					int _g = 0;
HXDLIN( 162)					::Array< ::Dynamic> _g1 = this->animationsArray;
HXDLIN( 162)					while((_g < _g1->length)){
HXLINE( 162)						 ::Dynamic anim = _g1->__get(_g);
HXDLIN( 162)						_g = (_g + 1);
HXLINE( 163)						::String animAnim = ( (::String)((HX_("",00,00,00,00) + anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic))) );
HXLINE( 164)						::String animName = ( (::String)((HX_("",00,00,00,00) + anim->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic))) );
HXLINE( 165)						int animFps = ( (int)(anim->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) );
HXLINE( 166)						bool animLoop = ( (bool)(anim->__Field(HX_("loop",64,a6,b7,47),::hx::paccDynamic)) );
HXLINE( 167)						::Array< int > animIndices = ( (::Array< int >)(anim->__Field(HX_("indices",27,47,54,e3),::hx::paccDynamic)) );
HXLINE( 168)						bool _hx_tmp;
HXDLIN( 168)						if (::hx::IsNotNull( animIndices )) {
HXLINE( 168)							_hx_tmp = (animIndices->length > 0);
            						}
            						else {
HXLINE( 168)							_hx_tmp = false;
            						}
HXDLIN( 168)						if (_hx_tmp) {
HXLINE( 169)							this->animation->addByIndices(animAnim,animName,animIndices,HX_("",00,00,00,00),animFps,animLoop,null(),null());
            						}
            						else {
HXLINE( 171)							this->animation->addByPrefix(animAnim,animName,animFps,animLoop,null(),null());
            						}
HXLINE( 174)						bool _hx_tmp1;
HXDLIN( 174)						if (::hx::IsNotNull( anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic) )) {
HXLINE( 174)							_hx_tmp1 = (( (::Array< int >)(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic)) )->length > 1);
            						}
            						else {
HXLINE( 174)							_hx_tmp1 = false;
            						}
HXDLIN( 174)						if (_hx_tmp1) {
HXLINE( 175)							this->addOffset(( (::String)(anim->__Field(HX_("anim",11,86,71,40),::hx::paccDynamic)) ), ::Dynamic(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic))->__GetItem(0), ::Dynamic(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic))->__GetItem(1));
            						}
            					}
            				}
            				else {
HXLINE( 179)					this->quickAnimAdd(HX_("idle",14,a7,b3,45),HX_("BF idle dance",03,fa,cc,7f));
            				}
            			}
            		}
HXLINE( 183)		this->originalFlipX = this->flipX;
HXLINE( 185)		bool _hx_tmp4;
HXDLIN( 185)		bool _hx_tmp5;
HXDLIN( 185)		bool _hx_tmp6;
HXDLIN( 185)		if (!(this->animOffsets->exists(HX_("singLEFTmiss",d2,2f,9c,b6)))) {
HXLINE( 185)			_hx_tmp6 = this->animOffsets->exists(HX_("singDOWNmiss",ad,e9,88,e4));
            		}
            		else {
HXLINE( 185)			_hx_tmp6 = true;
            		}
HXDLIN( 185)		if (!(_hx_tmp6)) {
HXLINE( 185)			_hx_tmp5 = this->animOffsets->exists(HX_("singUPmiss",66,22,08,8a));
            		}
            		else {
HXLINE( 185)			_hx_tmp5 = true;
            		}
HXDLIN( 185)		if (!(_hx_tmp5)) {
HXLINE( 185)			_hx_tmp4 = this->animOffsets->exists(HX_("singRIGHTmiss",89,cc,65,e3));
            		}
            		else {
HXLINE( 185)			_hx_tmp4 = true;
            		}
HXDLIN( 185)		if (_hx_tmp4) {
HXLINE( 185)			this->hasMissAnimations = true;
            		}
HXLINE( 186)		this->recalculateDanceIdle();
HXLINE( 187)		this->dance();
HXLINE( 189)		if (( (bool)(isPlayer) )) {
HXLINE( 191)			this->set_flipX(!(this->flipX));
            		}
            	}
...
void Character_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_216_update)
HXLINE( 217)		bool _hx_tmp;
HXDLIN( 217)		if (!(this->debugMode)) {
HXLINE( 217)			_hx_tmp = ::hx::IsNotNull( this->animation->_curAnim );
            		}
            		else {
HXLINE( 217)			_hx_tmp = false;
            		}
HXDLIN( 217)		if (_hx_tmp) {
HXLINE( 219)			if ((this->heyTimer > 0)) {
HXLINE( 221)				 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 221)				_hx_tmp->heyTimer = (_hx_tmp->heyTimer - elapsed);
HXLINE( 222)				if ((this->heyTimer <= 0)) {
HXLINE( 224)					bool _hx_tmp;
HXDLIN( 224)					bool _hx_tmp1;
HXDLIN( 224)					if (this->specialAnim) {
HXLINE( 224)						_hx_tmp1 = (this->animation->_curAnim->name == HX_("hey",dc,42,4f,00));
            					}
            					else {
HXLINE( 224)						_hx_tmp1 = false;
            					}
HXDLIN( 224)					if (!(_hx_tmp1)) {
HXLINE( 224)						_hx_tmp = (this->animation->_curAnim->name == HX_("cheer",8d,9a,b6,45));
            					}
            					else {
HXLINE( 224)						_hx_tmp = true;
            					}
HXDLIN( 224)					if (_hx_tmp) {
HXLINE( 226)						this->specialAnim = false;
HXLINE( 227)						this->dance();
            					}
HXLINE( 229)					this->heyTimer = ( (Float)(0) );
            				}
            			}
            			else {
HXLINE( 231)				bool _hx_tmp;
HXDLIN( 231)				if (this->specialAnim) {
HXLINE( 231)					_hx_tmp = this->animation->_curAnim->finished;
            				}
            				else {
HXLINE( 231)					_hx_tmp = false;
            				}
HXDLIN( 231)				if (_hx_tmp) {
HXLINE( 233)					this->specialAnim = false;
HXLINE( 234)					this->dance();
            				}
            			}
HXLINE( 237)			if (!(this->isPlayer)) {
HXLINE( 239)				if (::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("sing",4f,96,53,4c))) {
HXLINE( 241)					 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 241)					_hx_tmp->holdTimer = (_hx_tmp->holdTimer + elapsed);
            				}
HXLINE( 244)				if ((this->holdTimer >= ((::Conductor_obj::stepCrochet * ((Float)0.001)) * this->singDuration))) {
HXLINE( 246)					this->dance();
HXLINE( 247)					this->holdTimer = ( (Float)(0) );
            				}
            			}
HXLINE( 251)			bool _hx_tmp;
HXDLIN( 251)			if (this->animation->_curAnim->finished) {
HXLINE( 251)				_hx_tmp = ::hx::IsNotNull( this->animation->_animations->get((this->animation->_curAnim->name + HX_("-loop",11,c1,bf,30))) );
            			}
            			else {
...
HXLINE( 256)		this->super::update(elapsed);
            	}


void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_266_dance)
HXDLIN( 266)		bool _hx_tmp;
HXDLIN( 266)		if (!(this->debugMode)) {
HXDLIN( 266)			_hx_tmp = !(this->specialAnim);
            		}
            		else {
HXDLIN( 266)			_hx_tmp = false;
            		}
HXDLIN( 266)		if (_hx_tmp) {
HXLINE( 268)			if (this->danceIdle) {
HXLINE( 270)				this->danced = !(this->danced);
HXLINE( 272)				if (this->danced) {
HXLINE( 273)					this->playAnim((HX_("danceRight",a9,7f,a6,91) + this->idleSuffix),null(),null(),null());
            				}
            				else {
HXLINE( 275)					this->playAnim((HX_("danceLeft",da,cc,f9,df) + this->idleSuffix),null(),null(),null());
            				}
            			}
            			else {
HXLINE( 277)				if (::hx::IsNotNull( this->animation->_animations->get((HX_("idle",14,a7,b3,45) + this->idleSuffix)) )) {
HXLINE( 278)					this->playAnim((HX_("idle",14,a7,b3,45) + this->idleSuffix),null(),null(),null());
            				}
            			}
            		}
            	}
...
void Character_obj::playAnim(::String AnimName,::hx::Null< bool >  __o_Force,::hx::Null< bool >  __o_Reversed,::hx::Null< int >  __o_Frame){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_284_playAnim)
HXLINE( 285)		this->specialAnim = false;
HXLINE( 286)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 288)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 289)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 291)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 294)			this->offset->set(0,0);
            		}
HXLINE( 296)		if (::StringTools_obj::startsWith(this->curCharacter,HX_("gf",1f,5a,00,00))) {
HXLINE( 298)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 300)				this->danced = true;
            			}
            			else {
HXLINE( 302)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 304)					this->danced = false;
            				}
            			}
HXLINE( 307)			bool _hx_tmp;
HXDLIN( 307)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 307)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
HXLINE( 307)				_hx_tmp = true;
            			}
HXDLIN( 307)			if (_hx_tmp) {
HXLINE( 309)				this->danced = !(this->danced);
            			}
            		}
            	}
...
void Character_obj::recalculateDanceIdle(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_315_recalculateDanceIdle)
HXDLIN( 315)		bool _hx_tmp;
HXDLIN( 315)		if (::hx::IsNotNull( this->animation->_animations->get((HX_("danceLeft",da,cc,f9,df) + this->idleSuffix)) )) {
HXDLIN( 315)			_hx_tmp = ::hx::IsNotNull( this->animation->_animations->get((HX_("danceRight",a9,7f,a6,91) + this->idleSuffix)) );
            		}
            		else {
HXDLIN( 315)			_hx_tmp = false;
            		}
HXDLIN( 315)		this->danceIdle = _hx_tmp;
            	}
...
void Character_obj::addOffset(::String name,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_320_addOffset)
HXDLIN( 320)		::cpp::VirtualArray v = ::Array_obj< Float >::__new(2)->init(0,x)->init(1,y);
HXDLIN( 320)		this->animOffsets->set(name,v);
            	}
...
void Character_obj::quickAnimAdd(::String name,::String anim){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_325_quickAnimAdd)
HXDLIN( 325)		this->animation->addByPrefix(name,anim,24,false,null(),null());
            	}
