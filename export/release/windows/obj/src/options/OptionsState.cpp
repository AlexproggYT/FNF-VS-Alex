...
HXDLIN(  62)		 ::flixel::graphics::FlxGraphic imageToReturn = ::Paths_obj::addCustomGraphic(HX_("menuDesat",26,91,04,72));
HXDLIN(  62)		 ::Dynamic bg1;
HXDLIN(  62)		if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  62)			bg1 = imageToReturn;
            		}
            		else {
HXLINE(  62)			bg1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("menuDesat",26,91,04,72)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            		}
